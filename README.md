...
[![Build Status](https://img.shields.io/github/actions/workflow/status/kochkaev/kotlin-telegrambots/release.yml?branch=main)](https://github.com/kochkaev/kotlin-telegrambots/actions)
...
// build.gradle.kts
dependencies {
    implementation("io.github.kochkaev:kotlin-telegrambots:1.0.9+6.9.7.1") // Use the latest version
}
```
